        ...
        <c:forEach items="${notification}" var="notification" >
            <tr>
                <form method="Get" action ="UserTable" class = "form_notification">
                    <td class="table_column"><c:out value="${notification.nameCruise}" /></td>
                    <td class="table_column"><c:out value="${notification.cityDeparture}" /></td>
                    <td class="table_column"><c:out value="${notification.startCruise}" /></td>
                    <input type="hidden" name="ReviewId" value="<c:out value="${notification.reviewId}" />">
