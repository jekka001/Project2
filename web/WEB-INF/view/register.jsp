...
<form method="Get" action = "MainMenu" class= "form_menu">
    <input type="submit" name="Menu" value="<c:out value="${button_sign_in}" default="Sign in"/>" class="field_menu">
    <input type="submit" name="Menu" value="<c:out value="${button_register}" default="Register"/>" class="field_menu">
</form>
...
<form method="Post" action ="Register" class = "form_register">
    ...
    <input type="submit" name="Register" value="<c:out value="${button_register}" default="Register"/>" class="register_user">
</form>
</body>
<html>
